      ...
      <header>
        ...
        <div className="summary">
          ...
          <p>
            ...
            web applications or building smaller personal projects, often trying
            out new APIs or emerging libraries, eager to bind them to my will.
          </p>
          <p>
            I love to work with:
      ...
      <section className="experience">
        ...
        <div className="subsection">
          ...
          <p>
            ...
            freelance front-end developer. Successfully completed multiple
            projects for both large and small businesses and gained consistent
            positive feedback.
          </p>

          <p>
            <b>Achievements:</b> Many happy customers and a total rating of 4.97
            out of 5 👌
          </p>
        </div>
        <div className="subsection">
          ...
          <p>
            <b>Responsibilities:</b> PSD to HTML slicing, convert sliced designs
            to Wordpress themes, SEO, A/B testing
          </p>
        </div>
      </section>
      <section>
        ...
        <div className="subsection">
          ...
          <p>
            ...
            Built to work flawlessly on desktop, tablet and mobile.
          </p>
        </div>
      </section>
      <section>
